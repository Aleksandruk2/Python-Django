...
SECRET_KEY = 'django-insecure-ro3=r-8l7*zk6!t++p=762qep!7-^uy08)l&e^%5p8c%y2r$u#'
...
SPECTACULAR_SETTINGS = {
    ...
    'COMPONENT_SPLIT_REQUEST': True, #для form file Swagger
}
