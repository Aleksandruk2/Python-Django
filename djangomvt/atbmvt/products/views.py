    ...
    if request.method == "POST":
        ...
        if form.is_valid():
            ...
            for idx, img_id in enumerate(images_ids):
                ...
                img.priority = idx
                img.save()
            return redirect("products:show-products")  # назва URL на список товарів
    else:
        form = ProductForm()
    return render(request, "products/create.html", {"form": form})


def product_delete(_, product_id):
    try:
        ...
        pass
    return redirect('products:show-products')
...
def product_edit(request, product_id):
    ...
    if request.method == "POST": 
        ...
        if form.is_valid():
            ...
            # 🔥 2. Видаляємо зайві картинки
            current_ids = [int(i) for i in images_ids]
